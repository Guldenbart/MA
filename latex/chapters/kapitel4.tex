...
\begin{itemize}
	...
	\item \todo{genau einmal oder kein mal}
\end{itemize}
...
\noindent
Abbildung\todo{in Abschnitt...} stellt den Zusammenhang zwischen den Klassen in einem UML-Klassendiagramm dar.
